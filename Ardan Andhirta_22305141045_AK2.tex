...
See: http://www.google.de | Google
\end{eulercomment}
\eulerimg{24}{images/ardan-004.png}
\eulersubheading{}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/ardan-007.png}
\begin{eulerprompt}
>$&solve(a*x^2+b*x+c,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/ardan-010.png}
...
\begin{euleroutput}
  -2
\end{euleroutput}
\eulerimg{4}{images/ardan-011.png}
\begin{eulerprompt}
>88/4*3
\end{eulerprompt}
\begin{euleroutput}
  66
\end{euleroutput}
\eulerimg{1}{images/ardan-012.png}
\begin{eulerprompt}
>sin(120°) * cos(60°) 
\end{eulerprompt}
\begin{euleroutput}
