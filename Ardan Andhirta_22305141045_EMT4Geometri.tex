...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-003.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-005.png}
\begin{eulercomment}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-006.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-018.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-020.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable ysol not found!
  Use global or local variables defined in function H.
  Error in abs
  Error in return result.
  H: useglobal; return a*abs(ysol)/2 
...
\begin{euleroutput}
  ...
  %ploteval:  y0=f$(x[1],args());
  adaptiveevalone:        s=%ploteval(g$,t;args());
  plot2d:                         dw/n,dw/n^2,dw/n,auto;args());
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-052.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-055.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/Ardan Andhirta_22305141045_EMT4Geometri-062.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-071.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-097.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-104.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-105.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  %ploteval2:         return map(f$,x,y;args());
  fcontour:   Z=%ploteval2(f$,X,Y,maps;args());
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  Illegal function result in map.
  %ploteval2:         return map(f$,x,y;args());
  f3dplot:    z=%ploteval2(f$,x,y,maps;args());
  plot3d:                         wire,xlabel,ylabel,zlabel,sliced,maps,wirecolor;args()) ...
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-106.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-107.png}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-108.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-109.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function call to "f" failed in nelder.
  neldermin:          v1=_nelder(f$,v,d,eps;args());
\end{euleroutput}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-111.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-112.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-116.png}
...
\end{eulerprompt}
\begin{euleroutput}
  gp is not a variable you can index with []!
...
\begin{euleroutput}
  User interrupted!
  exec:   return _exec(program,param,dir,print,hidden,wait);
  povray:     exec(program,params,defaulthome);
  povend:         povray(file,w,h,aspect,exit); 
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  exec:   return _exec(program,param,dir,print,hidden,wait);
  povray:     exec(program,params,defaulthome);
  povanaglyph:        povray(currentfile,w,h,aspect,exit); 
\end{euleroutput}
...
\begin{euleroutput}
  ...
  S 7°36.357' E 109°58.197'
  S 7°35.026' E 109°55.227'
  S 7°33.313' E 109°51.409'
  S 7°31.029' E 109°46.320'
  S 7°27.829' E 109°39.196'
  S 7°23.026' E 109°28.513'
  S 7°15.011' E 109°10.717'
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-118.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-119.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-121.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-122.png}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-123.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-125.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-126.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-127.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-128.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-129.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-130.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Geometri-131.png}
\end{eulernotebook}
\end{document}
