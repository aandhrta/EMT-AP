...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-027.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-029.png}
\begin{eulerprompt}
...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-030.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-031.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-032.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-036.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-037.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-042.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-043.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-044.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  plot2d:                 ccc=_color(color); l=_linewidth(thickness); 
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-045.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function getspectral not found.
  Try list ... to find functions!
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-049.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-051.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-056.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-057.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-061.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-062.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-063.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-064.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-067.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-068.png}
...
- style="...": Pilih dari "#", "/", "\(\backslash\)", "\(\backslash\)/".
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-070.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-071.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-075.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-076.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-077.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-078.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-079.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-080.png}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-081.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-082.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-083.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-084.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-085.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-086.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-087.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-088.png}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-090.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-091.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-092.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-093.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-094.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-095.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-096.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-097.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-098.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-100.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-102.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-103.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-104.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-105.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-106.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-108.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-109.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-111.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-112.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-113.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-114.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-116.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-117.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-118.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-119.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-120.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-121.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-122.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-124.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-125.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-126.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-127.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-129.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-130.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-132.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-133.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-134.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-135.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-136.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Ardan Andhirta_22305141045_EMT4Plot2D (1)-137.png}
